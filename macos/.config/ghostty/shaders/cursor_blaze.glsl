...
const vec4 TRAIL_COLOR = vec4(0.796, 0.651, 0.969, 1.0); // #cba6f7 Catppuccin Mocha mauve
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.953, 0.545, 0.659, 1.0); // #f38ba8 Catppuccin Mocha pink
